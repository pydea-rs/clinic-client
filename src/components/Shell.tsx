  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50/80 overflow-hidden">
      ...
      <div className="lg:hidden flex-shrink-0">
        {/* Gradient accent bar */}
        <div className="h-0.5 bg-gradient-to-r from-brand-500 via-purple-500 to-brand-500" />
        <div className="bg-white/80 backdrop-blur-lg border-b border-gray-200/60 px-4 py-2.5 flex items-center justify-between">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Sidebar */}
        <aside className={`
          fixed lg:relative inset-y-0 left-0 z-50 w-[260px] border-r border-gray-200/60
        ...
        `}>
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-white via-white to-gray-50/50 backdrop-blur-xl" />
          <div className="relative flex flex-col h-full">
            ...
            <div className="hidden lg:flex p-5 items-center gap-3">
              <div className="relative">
                ...
                <div className="absolute -inset-2 bg-gradient-to-br from-brand-200/40 via-purple-200/30 to-brand-100/20 rounded-3xl blur-lg" />
                <div className="relative w-10 h-10 bg-gradient-to-br from-brand-600 via-brand-500 to-purple-500 rounded-2xl flex items-center justify-center shadow-lg shadow-brand-500/20 animate-gradient">
                      ...
                      return (
                        <Link
                          ...
                          className={`
                            ...
                            ${isActive
                              ? 'nav-item-active text-brand-700 font-semibold'
                        ...
                        >
                          ...
                          {!isActive && (
                            <div className="absolute inset-0 bg-gray-50 rounded-xl -translate-x-full group-hover:translate-x-0 transition-transform duration-300 ease-spring" />
                          )}
                          ...
                          <item.icon className={`relative z-10 flex-shrink-0 transition-all duration-200 ${
                            isActive
                              ? 'w-[20px] h-[20px] text-brand-600'
                              : 'w-[18px] h-[18px] text-gray-400 group-hover:text-gray-600'
                          }`} />
            ...
            <div className="p-3 mt-auto relative">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-brand-50/30 via-transparent to-transparent pointer-events-none" />

              <div className="relative">
                <div className="h-px bg-gradient-to-r from-transparent via-gray-200 to-transparent mb-3" />
                {isAuthenticated && user && (
                  <div className="flex items-center gap-3 px-3 py-3 mb-1 rounded-xl bg-gray-50/50 hover:bg-gray-100/60 transition-colors duration-200">
                    {/* Avatar with online dot */}
                    <div className="relative flex-shrink-0">
                      <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-brand-100 to-brand-50 flex items-center justify-center text-brand-700 text-xs font-bold shadow-sm ring-2 ring-brand-300/50">
                        {userInitials}
                      </div>
                      {/* Online status dot */}
